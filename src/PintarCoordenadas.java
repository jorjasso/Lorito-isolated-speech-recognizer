 ...
 * location.
 */
public class PintarCoordenadas {
    ...
    private static void createAndShowGUI() {
        ...
        JFrame frame = new JFrame("PintarCoordenadas");
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

        //Set up the content pane.
        PintarCoordenadas controller = new PintarCoordenadas();
    ...
    public static class CoordinateArea extends JComponent 
        ...
        Point point = null;
        PintarCoordenadas controller;
        Dimension preferredSize = new Dimension(400,75);
        Color gridColor;
    
        public CoordinateArea(PintarCoordenadas controller) {
