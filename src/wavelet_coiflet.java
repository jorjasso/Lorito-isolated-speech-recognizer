...
public class wavelet_coiflet{
	...
	public wavelet_coiflet(double [] datos){
...
/*		System.out.println(" matriz wavelet");
		for(i=0;i<matrizWavelet.length-2;i++){
...
//                System.out.println("tamaño en potencia()="+tamano); 
	...
	public static void main(String args[]){
		...
		double [] energia;
		reconocerWaveletCoiflet reconocer= new reconocerWaveletCoiflet(datos);
...
/*		double [] datos={4,6,10,12,8,6,5,5};
		wavelet_coiflet coiflet=new wavelet_coiflet(datos);
		int i;
