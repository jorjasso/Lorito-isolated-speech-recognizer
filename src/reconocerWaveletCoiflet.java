...
public class reconocerWaveletCoiflet{
	...
	public reconocerWaveletCoiflet(double [] arreglo){
...
//		ventaneamiento.imprimirMatriz();
		...
		/*******/
			...
			for(int i=0;i<filas;i++){ //computa iterativamente la matriz wavelet (Energia)
				wavelet_coiflet coiflet=new wavelet_coiflet(matrizWavelet[i]);
		//		matrizWavelet[i]= daubechies.coeficientes;
		//		datos=daubechies.coeficientes();	
				matrizEnergia[i]=coiflet.obtenerEnergia();
