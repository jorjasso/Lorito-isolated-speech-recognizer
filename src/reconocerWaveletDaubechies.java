...
public class reconocerWaveletDaubechies{
	...
	public reconocerWaveletDaubechies(double [] arreglo){
		//entra el arreglo de voz normalizada
		//sale una matriz de ventaneamiento
		 ventaneamiento=new Ventaneamiento(arreglo,256,160,0);//obtiene la matriz de ventaneamiento
...
//		ventaneamiento.imprimirMatriz();
		...
		/*******/
			...
			for(int i=0;i<filas;i++){ //computa iterativamente la matriz wavelet (Energia)
				wavelet_daubechies daubechies=new wavelet_daubechies(matrizWavelet[i]);
		//		matrizWavelet[i]= daubechies.coeficientes;
		//		datos=daubechies.coeficientes();	
				matrizEnergia[i]=daubechies.obtenerEnergia();
