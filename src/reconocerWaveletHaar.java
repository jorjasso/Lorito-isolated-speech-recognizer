...
public class reconocerWaveletHaar{
	...
	public reconocerWaveletHaar(double [] arreglo){
...
//		ventaneamiento.imprimirMatriz();
		...
		/*******/
			...
			for(int i=0;i<filas;i++){ //computa iterativamente la matriz wavelet (Energia)
				wavelet_haar haar=new wavelet_haar(matrizWavelet[i]);
		//		matrizWavelet[i]= haar.coeficientes;
		//		datos=haar.coeficientes();	
				matrizEnergia[i]=haar.obtenerEnergia();
