...
public class reconocerWaveletPacketDb3{
	...
	public reconocerWaveletPacketDb3(double [] arreglo){
...
//		ventaneamiento.imprimirMatriz();
		...
		/*******/
			...
			for(int i=0;i<filas;i++){ //computa iterativamente la matriz wavelet (Energia)
				waveletPacketDb3 PacketDb6=new waveletPacketDb3(matrizWavelet[i]);
		//		matrizWavelet[i]= daubechies.coeficientes;
		//		datos=daubechies.coeficientes();	
				matrizEnergia[i]=PacketDb6.obtenerEnergia();
