...
public class reconocerWaveletPacketPSBC{
	...
	public reconocerWaveletPacketPSBC(double [] arreglo){
...
//		ventaneamiento.imprimirMatriz();
		...
		/*******/
			...
			for(int i=0;i<filas;i++){ //computa iterativamente la matriz wavelet (Energia)
				waveletPacketPSBC PacketDb4=new waveletPacketPSBC(matrizWavelet[i]);
