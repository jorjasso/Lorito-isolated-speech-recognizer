...
public class reconocerWaveletDaubechies3{
	...
	public reconocerWaveletDaubechies3(double [] arreglo){
		//entra el arreglo de voz normalizada
		//sale una matriz de ventaneamiento
		 ventaneamiento=new Ventaneamiento(arreglo,512,160,0);//obtiene la matriz de ventaneamiento
...
//		ventaneamiento.imprimirMatriz();
		...
		/*******/
			...
			for(int i=0;i<filas;i++){ //computa iterativamente la matriz wavelet (Energia)
				wavelet_daubechiesdb3 daubechies3=new wavelet_daubechiesdb3(matrizWavelet[i]);
		//		matrizWavelet[i]= daubechies.coeficientes;
		//		datos=daubechies.coeficientes();	
				matrizEnergia[i]=daubechies3.obtenerEnergia();
